@section('title_page', ($identity === 'daerah' ? '- Data Daerah' : ($identity === 'pasien' ? '- Registrasi Pasien' : '' )))

<x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        {{ $identity === 'daerah' ? 'Data Daerah' : ($identity === 'pasien' ? 'Registrasi Pasien' : '' ) }}
    </h2>
</x-slot>
            ...
            <div>
                <div class="overflow-x-auto shadow-md rounded-lg">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <div class="flex items-center justify-between mb-1 p-2">
                                @if($identity === 'daerah')
                                    @include('livewire.admin.add')
                                    @include('livewire.admin.edit')
                                    <x-jet-button class="bg-blue-500 hover:bg-blue-700 w-12" wire:click="confirmAdd()" title="Tambah">
                                ...
                                @if($identity === 'pasien')
                                    ...
                                    @include('livewire.operator.edit')
                                ...
                                <div class="flex items-center h-10">
                                    @if($this->searchableColumns()->count())
                                        <div class="flex rounded-lg md:w-96 w-20% shadow-sm">
